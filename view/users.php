...
<head>
<meta charset="UTF-8">
<meta name="keywords" content="Customer relationship Management system, crm, customers">
    <meta name="description" content="A customer relations management portal for managing interactions and relationships with clients as well as streamline processes, improve customer service, increase sales, and facilitate communication between various departments">
            ...
            <section id="contents">
                ...
                <div id="quickLinks">
                    <div class="quick_links">
                        ...
                        ?>
                        <div class="links page_navs" onclick="showPage('prescription.php')" title="Add new prescription">
