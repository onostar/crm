...
function addCustomer(){
     ...
     /* }else if(address.length == 0 || address.replace(/^\s+|\s+$/g, "").length == 0){
          ...
          $.ajax({
               ...
               data : {other_names:other_names, last_name:last_name, phone_number:phone_number, email:email, address:address, customer_store:customer_store, dob:dob},
               success : function(response){
               $(".info").html(response);
               }
          })
...
function updateCustomer(){
    ...
    /*  }else if(address.length == 0 || address.replace(/^\s+|\s+$/g, "").length == 0){
          ...
          $.ajax({
               ...
               data : {customer_id:customer_id, last_name:last_name, other_names:other_names, phone_number:phone_number, email:email, address:address, dob:dob},
               success : function(response){
...
function addPrescription(){
     ...
     if(details.length == 0 || details.replace(/^\s+|\s+$/g, "").length == 0){
          ...
          $.ajax({
               ...
               data : {customer:customer, posted_by:posted_by, invoice:invoice, details:details, drug:drug},
               success : function(response){
               $(".sales_order").html(response);
               }
          })
